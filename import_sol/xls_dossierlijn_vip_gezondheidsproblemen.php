<?    
    ...
    // GET DATA
    $leerlingen = get_vip_gezondheidsproblemen_data();
    ...
    if($_GET['type'] == "CSV"){
        ...
        $filename = "dossierlijnen_vip_gezondheidsproblemen_" . date("Ymd_Hi") . ".csv";
    } else {
        header('Content-Type: application/vnd.ms-excel; charset=iso-8859-1');    
        $filename = "dossierlijnen_vip_gezondheidsproblemen_" . date("Ymd_Hi") . ".xls";
    }        
