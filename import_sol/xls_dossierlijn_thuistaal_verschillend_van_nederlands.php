<?    
    ...
    // GET DATA
    $leerlingen = get_thuistaal_verschillend_van_nederlands_data();
    ...
    if($_GET['type'] == "CSV"){
        ...
        $filename = "dossierlijnen_thuistaal_verschillend_van_nederlands_" . date("Ymd_Hi") . ".csv";
    } else {
        header('Content-Type: application/vnd.ms-excel; charset=iso-8859-1');    
        $filename = "dossierlijnen_thuistaal_verschillend_van_nederlands_" . date("Ymd_Hi") . ".xls";
    }                    
