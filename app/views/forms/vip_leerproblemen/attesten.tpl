...
<div style="margin-top: 30px;text-align:center;">
    ...
    <div id="attesten_nee_con" [DISABLED_ATTTESTEN_NEE_CON]>
        <strong>Geen compenserende maatregelen</strong>
        <input type="hidden" id="attesten_extra_nee" value="Geen compenserende maatregelen">    
    </div>

    <div id="attesten_ja_con" [DISABLED_ATTTESTEN_JA_CON]>
        <strong>Asap bezorgen, dan pas overleg rond compenserende maatregelen</strong>
        <input type="hidden" id="attesten_extra_ja" value="Asap bezorgen, dan pas overleg rond compenserende maatregelen">
    </div>
</div>
