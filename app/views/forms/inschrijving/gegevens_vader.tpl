...
<table class="formulierdubbel">
    <tr>
        ...
        <th>GSM</th>
        <td><input type="text" id="vader_gsm" value="[GSM]" tabindex="4"></td>        
    </tr>
    <tr>
        <th>Voornaam</th>
        ...
        <th>Email</th>
        <td><input type="text" id="vader_email" value="[EMAIL]" tabindex="5"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="checkbox" id="vader_zelfde_als_lln" style="width:20px;"></td>
    </tr>    
    <tr>
        <th>Straat + nr</th>
        <td colspan="3">
