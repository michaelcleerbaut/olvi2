...
<table style="margin-left: 80px;">
    ...
    <tr>
        <td style="width: 300px;text-align:center;">
            <select id="stroom_select" style="padding:5px;" disabled="disabled"><option value="A">A</option><option value="B">B</option></select>
            <input type="text" id="volgnummer" value="" style="width: 40px;text-align:center;padding: 5px;" disabled="disabled">
        </td>        
...
<script type="text/javascript">
    ...
    $('.search_kind_via_naam').autocomplete2({
      serviceUrl:'/ajax.php?action=search_kind_via_naam_vip_andereproblemen',
      minChars:2,
