...
<div style="margin-top: 30px;text-align:center;">
    ...
    <div id="attesten_nee_con" [DISABLED_ATTTESTEN_NEE_CON]>
        <strong>Leerkrachten krijgen algemene info</strong>
        <input type="hidden" id="attesten_extra_nee" value="Leerkrachten krijgen algemene info">    
    </div>

    <div id="attesten_ja_con" [DISABLED_ATTTESTEN_JA_CON]>
        <strong>Asap bezorgen</strong>
        <input type="hidden" id="attesten_extra_ja" value="Asap bezorgen">
    </div>
</div>
